...
<!-- Hoja de estilos. -->
<style>
    <?php include __DIR__ . '/css/preparadores.css'; ?>
</style>

<!-- Cuerpo principal. -->
<div class="preparadoresBody">
            ...
            <div class="windowBox">
                ...
                <div>
                    <fieldset>
                        ...
                        <div class="preparadoresLast"></div>
                    </fieldset>
                </div>
                <br>
                <div>
...
<!-- Javascript. -->
<script>
    <?php include __DIR__ . '/js/preparadores.js'; ?>
</script>
